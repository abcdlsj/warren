...
/// Polls git status for all known worktrees in parallel and returns a merged snapshot.
@MainActor
            ...
            for worktree in activeWorktrees {
                group.addTask {
                    do {
                        ...
                        // A broken or unavailable repo should not block the rest of the sidebar.
