...
public actor URLSessionWebSocketClientTransport: HostTransport {
    ...
    private let injectedTask: (any WarrenWebSocketTaskAdapter)?
    ...
    private var taskAdapter: (any WarrenWebSocketTaskAdapter)?
    ...
    private func runReceiveLoop(using adapter: any WarrenWebSocketTaskAdapter) async {
        do {
    ...
    private func failTransport(with error: Error, adapter: any WarrenWebSocketTaskAdapter) async {
