...
final class SupersetImportSourceTests: XCTestCase {
    ...
    func testPreviewRejectsIncompatibleSchema() async throws {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("BurrowSupersetSchemaTests-\(UUID().uuidString)", isDirectory: true)
...
private struct TemporaryImportDatabase {
    ...
    init() throws {
        directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("BurrowImportCommit-\(UUID().uuidString)", isDirectory: true)
...
private struct SupersetFixtureDatabase {
    ...
    init() throws {
        directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("BurrowSupersetFixture-\(UUID().uuidString)", isDirectory: true)
