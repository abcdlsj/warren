...
final class BurrowDesignSystemTests: XCTestCase {
    func testSupersetLayoutMeasurementsAreCentralized() {
        ...
        XCTAssertEqual(BurrowLayoutMetrics.sidebarProjectRowHeight, 32)
        XCTAssertEqual(BurrowLayoutMetrics.sidebarWorkspaceRowHeight, 28)
        XCTAssertEqual(BurrowLayoutMetrics.sidebarSectionLabelHeight, 32)
        XCTAssertEqual(BurrowLayoutMetrics.sidebarRowIconSlotSize, 20)
