...
@testable import BurrowLocalTransport

final class BurrowLocalTransportTests: XCTestCase {
    ...
    private func workspace() -> Workspace {
        Workspace(id: workspaceID, projectID: projectID, name: "burrow", path: "/tmp/burrow")
    }
