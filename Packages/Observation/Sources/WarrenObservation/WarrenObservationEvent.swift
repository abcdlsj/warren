...
public struct WarrenObservationContext: Codable, Hashable, Sendable {
...
public enum WarrenObservationEventKind: String, Codable, Hashable, Sendable {
    case command
    case resource
    case layout
    case renderer
...
public struct WarrenObservationEvent: Codable, Hashable, Sendable, Identifiable {
    public let id: UUID
    public let sequence: UInt64
    public let timestampNanoseconds: UInt64
    public let kind: WarrenObservationEventKind
    public let name: String
    public let context: WarrenObservationContext
    ...
    public init(
        ...
        kind: WarrenObservationEventKind,
        name: String,
        context: WarrenObservationContext,
...
public actor WarrenObservationLog {
    public typealias Clock = @Sendable () -> UInt64

    private let capacity: Int
    private let clock: Clock
    private var nextSequence: UInt64 = 0
    private var retained: [WarrenObservationEvent] = []
    ...
    public func record(
        kind: WarrenObservationEventKind,
        name: String,
        context: WarrenObservationContext = WarrenObservationContext(),
        previousState: String? = nil,
        nextState: String? = nil,
        result: String? = nil,
        errorCode: String? = nil
    ) -> WarrenObservationEvent {
        let event = WarrenObservationEvent(
    ...
    public func events(since sequence: UInt64? = nil) -> [WarrenObservationEvent] {
