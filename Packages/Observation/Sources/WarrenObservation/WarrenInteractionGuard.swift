...
public struct WarrenInteractionSnapshot: Codable, Equatable, Sendable {
...
public enum WarrenInteractionGuardError: Error, Equatable {
...
@MainActor
public enum WarrenInteractionGuard {
    public static func capture() -> WarrenInteractionSnapshot {
        let point = NSEvent.mouseLocation
        return WarrenInteractionSnapshot(
    ...
    public static func verifyUnchanged(
        from expected: WarrenInteractionSnapshot,
        to actual: WarrenInteractionSnapshot
    ) throws {
        guard expected.frontmostApplicationPID == actual.frontmostApplicationPID else {
            throw WarrenInteractionGuardError.frontmostApplicationChanged(
        ...
        guard expected.mouseX == actual.mouseX, expected.mouseY == actual.mouseY else {
            throw WarrenInteractionGuardError.mouseMoved(
