...
extension BurrowApplicationService {
        ...
        do {
            ...
            case let .attached(snapshot):
                guard let attachmentID = snapshot.attachmentID else {
                    throw BurrowApplicationError.transport("Host returned an attached message without an attachment ID.")
                }
    ...
    private func completeAttachmentWaiter(
        ...
        result: Result<TerminalAttachmentID, BurrowApplicationError>
    ) {
    ...
    private func completeControlWaiter(
        sessionID: TerminalSessionID,
        attachmentID: TerminalAttachmentID?,
        result: Result<Void, BurrowApplicationError>
    ) {
