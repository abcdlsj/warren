...
extension WarrenApplicationService {
    ...
    public func sendClientInput(
        ...
        guard let metadata = InputMetadata(
            ...
            throw WarrenApplicationError.transport("Invalid remote terminal input length.")
        }
    ...
    public func requestControl(
        ...
        let pair = AsyncStream<Result<Void, WarrenApplicationError>>.makeStream()
        let token = UUID()
        ...
        do {
            ...
            throw WarrenApplicationError.transport(String(describing: error))
        }
        ...
        throw WarrenApplicationError.transport("Control confirmation stream ended.")
    }
    ...
    public func sendInput(
        ...
        guard let metadata = InputMetadata(
            ...
            throw WarrenApplicationError.protocolFailure(
                ProtocolError(
                    code: .invalidFrame,
    ...
    internal func requireAttachment(
        ...
        guard connection.attachmentID == attachmentID else {
            throw WarrenApplicationError.attachmentNotFound(attachmentID)
        }
    }
    ...
    internal func attachInternal(
        ...
        let pair = AsyncStream<Result<TerminalAttachmentID, WarrenApplicationError>>.makeStream()
        let token = UUID()
        ...
        throw WarrenApplicationError.transport("Terminal attachment confirmation stream ended.")
    }
}
