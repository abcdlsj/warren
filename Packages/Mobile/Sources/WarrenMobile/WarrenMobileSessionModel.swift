...
public enum WarrenMobileStatusTone: Hashable, Sendable {
    case positive
    case caution
    case destructive
    case neutral
...
public struct WarrenMobileSessionModel: Hashable, Identifiable, Sendable {
    ...
    public var statusTone: WarrenMobileStatusTone {
        switch connectionState {
