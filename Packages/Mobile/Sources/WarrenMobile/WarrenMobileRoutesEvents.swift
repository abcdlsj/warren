...
public enum WarrenMobileRoute: Hashable, Sendable {
    case host(HostID)
    case workspace(WorkspaceID)
    case session(TerminalSessionID)
}

/// Button output for the app layer. WarrenMobile does not interpret or send it.
public enum WarrenMobileEvent: Hashable, Sendable {
    case terminalInput(sessionID: TerminalSessionID, key: WarrenMobileTerminalKey)
...
public enum WarrenMobileTerminalKey: String, CaseIterable, Hashable, Identifiable, Sendable {
    case escape
    case control
    case tab
    case arrowUp
