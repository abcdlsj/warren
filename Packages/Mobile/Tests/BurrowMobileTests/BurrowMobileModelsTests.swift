import XCTest
@testable import BurrowMobile
import BurrowClientCore
import BurrowDomain

final class BurrowMobileModelsTests: XCTestCase {
    func testSamplePreservesHostWorkspaceSessionHierarchy() throws {
        let fixture = BurrowMobileFixture.sample()
    ...
    func testSnapshotConversionRejectsDifferentSession() throws {
        ...
        XCTAssertNil(BurrowMobileSessionModel(session: session.session, title: "Mismatch", snapshot: snapshot))
    }
}
