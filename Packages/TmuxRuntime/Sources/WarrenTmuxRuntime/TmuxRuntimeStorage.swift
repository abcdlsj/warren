...
extension TmuxRuntime {
    ...
    func prepareSpool(for name: String) throws -> URL {
        ...
        do {
            ...
            throw TmuxRuntimeError.outputSpoolUnavailable(
                ...
                recovery: "Check Warren's write access to Application Support."
            )
        }
        ...
        do {
            ...
            throw TmuxRuntimeError.outputSpoolUnavailable(
                path: url.path,
                reason: String(describing: error),
                recovery: "Check Warren's write access to the output directory."
            )
        }
        return url
    }
    ...
    static func inputBufferName(for sessionID: TerminalSessionID) -> String {
        "warren-input-\(sessionID.description)"
    }
