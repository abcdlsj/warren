...
/// Environment policy for processes and shells hosted by Burrow.
///
...
/// launcher, not the terminal Burrow hosts, so they must not leak into tmux.
enum BurrowTerminalEnvironment {
    static let termProgram = "Burrow"
