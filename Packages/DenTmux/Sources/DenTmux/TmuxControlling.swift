...
/// Protocol boundary around tmux operations used by the app.
public protocol TmuxControlling: Sendable {
    ...
    func cloneSessionGroup(sourceSessionId: String, cloneSessionId: String) async throws -> TmuxSession
...
public extension TmuxControlling {
    ...
    // These defaults make it possible to adopt the protocol incrementally.
    func selectSession(id: String) async throws {
        throw TmuxError.notYetImplemented("selectSession")
    }

    func cloneSessionGroup(sourceSessionId: String, cloneSessionId: String) async throws -> TmuxSession {
        throw TmuxError.notYetImplemented("cloneSessionGroup")
    }
