...
final class BurrowRendererCoordinatorTests: XCTestCase {
    ...
    func testOnlyActiveWorkspaceAndTabCanSendInputOrResize() async throws {
        ...
        let coordinator = BurrowRendererCoordinator(service: service, windowID: fixture.windowID)
...
private actor RendererServiceSpy: BurrowRendererService {
...
private struct Fixture {
    ...
    let firstSession: BurrowApplicationSession
    let secondSession: BurrowApplicationSession
    let snapshot: BurrowApplicationSnapshot
    ...
    var firstKey: BurrowRendererSurfaceKey {
        BurrowRendererSurfaceKey(
            windowID: windowID,
    ...
    var secondKey: BurrowRendererSurfaceKey {
        BurrowRendererSurfaceKey(
            windowID: windowID,
    ...
    private static func session(
        ...
        return BurrowApplicationSession(
            id: id,
    ...
    private static func view(
        workspace: Workspace,
        session: BurrowApplicationSession
    ) -> ClientWorkspaceView {
        let tab = ClientTab(
            id: session.tabID,
            title: session.title,
