...
const messages = {
  en: {
    ...
    "nav.source": "Source",
    "hero.kicker": "Local-first AI coding workspace",
    "hero.titleA": "Your AI coding session,",
    "hero.titleB": "kept alive.",
    "hero.lede":
      "Run Codex or Claude Code on your Mac or VPS. Close Warren, lose Wi-Fi, or switch clients; the host keeps the session ready to resume from the desktop, web, or CLI.",
    ...
    "product.title": "One workspace for terminal and agents.",
    "product.caption": "Projects and workspaces on the left; terminal tabs, sessions, Git context, and agent views in the middle.",
    ...
    "features.lede": "That is how a coding task survives the client.",
    "features.items": [
      {
